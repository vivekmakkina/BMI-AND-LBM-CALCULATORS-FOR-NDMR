...
const VecuroniumScreen = () => {
  return (
    <View style={styles.container}>
      {/* Container 1 */}
      <View style={styles.container1}>
        <Text style={styles.container1Text}>Vecuronium</Text>
      </View>
      ...
      <View style={styles.container2}>
        ...
        <View style={styles.subContainer}>
          <Text style={styles.subContainerTitle}>Vecuronium</Text>
          <View style={styles.subContainerContent}>
            <Text style={styles.subContainerContentText}>0.1 mg/kg iv</Text>
          </View>
        </View>
...
export default VecuroniumScreen;